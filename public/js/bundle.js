...
exports.signup = exports.logout = exports.login = exports.adminLogin = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(name, email, password, passwordConfirm, company, yearOfCompletion, mobile) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error while singing  out! Try again! may be email is duplicate.');
        case 11:
        case "end":
  ...
  return function signup(_x5, _x6, _x7, _x8, _x9, _x10, _x11) {
...
exports.updateSettings = exports.shareExperience = exports.postReferral = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var shareExperience = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(experience, userId, companyName) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Interview Experience Posted successfully!");
          }
          _context2.next = 10;
          break;
        case 7:
  ...
  return function shareExperience(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
exports.shareExperience = shareExperience;
var postReferral = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(companyName, location, link, userId, role) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Referral Posted successfully!");
          }
          _context3.next = 11;
          break;
        case 8:
  ...
  return function postReferral(_x6, _x7, _x8, _x9, _x10) {
    return _ref3.apply(this, arguments);
  };
}();
exports.postReferral = postReferral;
...
exports.contributeToCollege = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NTM8kSE9OEOSVUmLe8sJk1ie42sJGeDpIv1zXRHgoi8pwlYTXEalhQh2XVOTXSZL7ljvpPlrXnQGbeB7u8QvB8L00xug0Bj9G');
var contributeToCollege = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:3000/api/v1/payments/checkout-session/".concat(userId, "/").concat(amount));
        case 3:
  ...
  return function contributeToCollege(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.contributeToCollege = contributeToCollege;
...
var shareExperienceForm = document.querySelector('.form-user-interview-experience');
var referralForm = document.querySelector('.form-user-referrals');
var contributeForm = document.querySelector('.form-user-contribute');
var AdminLoginForm = document.querySelector('.form--admin-login');
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(name, email, password, passwordConfirm, company, yearOfCompletion, mobile);
  });
}
...
if (AdminLoginForm) {
  AdminLoginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _login.adminLogin)(email, password);
  });
}
...
if (shareExperienceForm) {
  shareExperienceForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var myTextarea, company, companyName, userTextarea, userId, experience;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            ...
            userTextarea = document.getElementById('userTextarea');
            userId = userTextarea.name;
            experience = myTextarea.value;
            (0, _updateSettings.shareExperience)(experience, userId, companyName);
          case 8:
          case "end":
            return _context2.stop();
        }
...
if (referralForm) {
  referralForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var userTextarea, company, locationEle, linkEle, roleEle, role, companyName, location, link, userId;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            userTextarea = document.getElementById('userTextarea');
            company = document.getElementById('companyName');
            locationEle = document.getElementById('location');
            linkEle = document.getElementById('link');
            ...
            link = linkEle.value;
            userId = userTextarea.name;
            (0, _updateSettings.postReferral)(companyName, location, link, userId, role);
          case 12:
          case "end":
            return _context3.stop();
        }
...
if (contributeForm) {
  contributeForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var amount, user, userId;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            ...
            user = document.getElementById('userTextarea');
            userId = user.name;
            console.log(amount.value, userId);
            (0, _stripe.contributeToCollege)(amount.value, userId);
          case 7:
          case "end":
            return _context4.stop();
        }
